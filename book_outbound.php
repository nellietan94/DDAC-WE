...
<html>
<head>
	<title>Maersk Line - West Europe - Outbound Booking</title>
	<meta charset="utf-8">
	...
	<div class="container-fluid">
		...
		<?php 
			...
			if(isset($_POST['submit'])){
				...
				echo $add_outbound = $outbound->bookOutbound($mycompany_name,$myproduct_category,$mytransportation,$myshipping_from,$myshipping_from_address,$myshipping_to,$myshipping_to_address,$myship_date,$myship_time,$mybook,$mydate);
			}
		?>
		<form method="POST">
